...
async def run_test():
    ...
    try:
        ...
        # Click on the 'Log in' link to go to login page
        ...
        try:
            ...
            raise AssertionError('Test case failed: User login was not successful. The user did not reach the dashboard after entering a valid email and correct OTP as per the test plan.')
