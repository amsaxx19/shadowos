...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Users signing in with emails ending with @example.com should bypass actual OTP sending and login successfully with OTP 123456, but the login did not succeed as expected.")
