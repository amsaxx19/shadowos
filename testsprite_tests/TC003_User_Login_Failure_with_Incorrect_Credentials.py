...
async def run_test():
    ...
    try:
        ...
        # Click the 'Log in' button to go to the login page
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login should be rejected with an invalid email or password, but the success message was found instead.')
