            ...
            <div className="min-h-screen bg-green-50 flex items-center justify-center p-4">
                <Card className="w-full max-w-lg shadow-xl border-green-100">
                    <CardHeader className="text-center pb-2">
                        ...
                        <p className="text-green-700">Thank you for your purchase (Simulation).</p>
                    </CardHeader>
                    <CardContent className="space-y-6 pt-6">
                        <div className="bg-white p-4 rounded-lg border border-green-100 shadow-sm">
                            <h3 className="font-bold text-gray-900 mb-1">Mock Product Title</h3>
                            <p className="text-sm text-gray-500 mb-4">This is a simulated product description.</p>
