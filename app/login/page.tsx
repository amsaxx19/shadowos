        ...
        <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <Card className="w-full max-w-[400px] bg-[#121212] border-[#222] shadow-2xl relative z-10 rounded-2xl">
                <CardHeader className="space-y-4 pb-2">
                    ...
                    <CardTitle className="text-2xl font-bold text-center text-white">Sign in to CUANBOSS</CardTitle>
                ...
                <CardContent className="space-y-6">
                    <form action={login} className="space-y-4">
                        ...
                        <Button
                            type="submit"
                            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-11 rounded-lg transition-all active:scale-95"
                        >
                            Continue
                        </Button>
                    </form>
                    ...
                    <div className="flex gap-3">
                        <Button variant="outline" className="flex-1 bg-[#1c1c1c] border-[#333] hover:bg-[#222] hover:text-white h-11 rounded-lg active:scale-95 transition-transform" onClick={() => toast.info("Google Login Coming Soon!")}>
                        ...
                        <Button variant="outline" className="flex-1 bg-[#1c1c1c] border-[#333] hover:bg-[#222] hover:text-white h-11 rounded-lg active:scale-95 transition-transform" onClick={() => toast.info("Apple Login Coming Soon!")}>
                        ...
                        <Button variant="outline" className="flex-1 bg-[#5865F2] border-[#5865F2] hover:bg-[#4752C4] hover:text-white h-11 rounded-lg active:scale-95 transition-transform">
                            <svg className="h-5 w-5 fill-current text-white" viewBox="0 0 24 24">
